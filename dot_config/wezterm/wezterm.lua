...
config.text_background_opacity = 0.39
...
-- background
local background = "1.jpg"
config.window_background_image = wezterm.home_dir .. "/.config/wezterm/images/" .. background
...
-- config.show_close_tab_button_in_tabs = false -- Nighly Only
